...
### Notizen Aufgabe 1
Wenn man sicht versucht anzumelden ist im Response HTML eine Backup Datei mit 3 Usern hinterlegt. Wird im UI nicht angezeigt aber ist über den Code erreichbar.
...
HTML response gibt auch Hinweis wenn Benutername korrekt ist aber Passwort falsch ist.
